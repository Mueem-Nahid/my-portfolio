...
export function LabProjectCard({ project }: LabProjectCardProps) {
  return (
    <article className="flex w-[min(18rem,80vw)] shrink-0 snap-start flex-col rounded-xl border border-line bg-panel p-5 transition-colors duration-200 hover:border-warm/30 hover:shadow-[0_0_32px_rgba(242,165,90,0.08)] motion-reduce:transition-none sm:w-80">
